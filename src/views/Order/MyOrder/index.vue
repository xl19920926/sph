...
<template>
  ...
  <div class="order-right">
    ...
    <div class="order-content">
      ...
      <div class="orders">
        <!-- v-for遍历数据 订单列表 -->
        <table class="order-item" v-for="item in store.state.order.orderList?.records" v-bind:key="item.id">
          <thead>
            <tr>
              <th colspan="5">
          ...
          <tbody>
            <tr v-for="item2 in item.orderDetailList">
              <td width="60%">
      ...
      <!-- 分页器 -->
      <Pagination 
        v-bind:total="store.state.order.orderList?.total" 
        v-bind:pageSize="store.state.order.orderList?.size" 
      ...
      <!-- <div class="choose-order">
        <div class="pagination">
          ...
          <div>
            <span>&nbsp;&nbsp;&nbsp;&nbsp;共{{store.state.order.orderList?.pages}}页&nbsp;</span>
          </div>
        </div>
      </div> -->
    </div>
    ...
    <div class="like">
      ...
      <ul class="like-list">
        <li class="likeItem">
          ...
          <div class="attr">
            <em>DELL戴尔Ins 15MR-7528SS 15英寸 银色
              笔记本</em>
          </div>
          <div class="price">
            <em>¥</em>
